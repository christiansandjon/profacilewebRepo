...
public class Coach implements Serializable{
	...
	public void setCoach(String email) {
	...
	public boolean save() {
		...
		try{  
			...
			Statement stmt=con.createStatement();  
			String sql = "INSERT INTO enseignant(id,nom,prenom,email,motpasse) VALUES (NULL,'"+this.nom+"','"+this.prenom+"','"+this.email+"','"+this.motpasse+"')";
			stmt.executeUpdate(sql);  
			return true;
			}catch(Exception e){ System.out.println(e);
			return false;
	...
	public void dateFromCoach(String email) {
