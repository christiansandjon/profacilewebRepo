		...
		<div class="contact_info_container">
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-6">
					<h1>Élèves</h1>
<p>Aucun enregistrement disponible pour l'instant</p>
					...
					<div class="col-lg-6">
						<div class="contact_info">
							...
							<div class="contact_info_text">
								<p>ienvenue sur Profacile Administration. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec vel gravida arcu. Vestibulum feugiat, sapien ultrices fermentum congue, quam velit venenatis sem</p>
							</div>
						</div>
					</div>
				</div>
