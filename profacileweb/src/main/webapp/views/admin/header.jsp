						...
						<div class="col">
							<div class="top_bar_content d-flex flex-row align-items-center justify-content-start">
								<ul class="top_bar_contact_list">
									<li><div class="question">Rendre l'éducation facile</div></li>
									<li>
								...
								<div class="top_bar_login ml-auto">
									<div class="login_button"><a href="../admin/logout">Logout</a></div>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col">
						<div class="header_content d-flex flex-row align-items-center justify-content-start">
							<div class="logo_container">
								<a href="#">
									<div class="logo_text">Pro<span>facile</span> <span style='font-size:1em;color:black;'>Admin</span></div>
								</a>
							</div>
							<nav class="main_nav_contaner ml-auto">
							<ul class="main_nav">
								<li><a href="../admin/tb">Tableau de bord</a></li>
								<li><a href="../admin/eleve">Élèves</a></li>
								<li><a href="../admin/enseignant">Enseignants</a></li>
