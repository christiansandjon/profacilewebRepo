				...
				<div class="row">
					<div class="col">
						<div class="header_content d-flex flex-row align-items-center justify-content-start">
							...
							<ul class="main_nav">
								<li><a href="../student/calendrier">Calendrier</a></li>
								<li><a href="../student/mescours">Mes cours</a></li>
								<li><a href="../student/enseignant">Enseignants</a></li>
								<li><a href="../student/compte">Compte</a></li>
							</ul>
