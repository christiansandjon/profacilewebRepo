		...
		<div class="contact_info_container">
			<div class="container">
				<div class="row">
					...
					%>
					<p style='text-align:center;'><span style="color:red;">Email ou mot de passe éronné</span></p>
					<% } %>
					<form method="POST" action="/profacileweb/student" class="counter_form_content d-flex flex-column align-items-center justify-content-center">
							<input type="email" class="comment_input" name="email" placeholder="Email :" required="required">
							<input type="password" class="comment_input" name="motpasse" placeholder="Mot de passe:" required="required">
							
					
							<button type="submit" class="comment_button trans_200">Connexion</button>
							<p><a href="/profacileweb/student/register">Pas encore inscrit? S'inscrire</a></p>
						</form>
						</div>
					</div>
