						...
						<div class="contact_form">
							...
							<table class="tab">
								<c:forEach var="mescours" items="${mescours}">
									<tr>
										<td>Cours: <span style="font-weight:bold;">${mescours.offre.cours.intitule} </span><br/>Niveau:<span style="font-weight:bold;">${mescours.offre.niveau} </span><br/>Élève:<span style="font-weight:bold;">${mescours.offre.eleve.nom} ${mescours.offre.eleve.prenom}</br>Email:${mescours.offre.eleve.email}</br>Télephone:${mescours.offre.eleve.telephone}</span>
										</td>
									</tr>
