				...
				<div class="row">
					...
					<div class="col-lg-6">
						<div class="contact_form">
							<div class="contact_info_title">Selectionner les matieres que vous coachez </div>
					...
					<form method="POST" action="/profacileweb/coach/register2" class="counter_form_content d-flex flex-column align-items-center justify-content-center">
