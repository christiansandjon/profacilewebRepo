		...
		<div class="contact_info_container">
			<div class="container">
				<div class="row">
					...
					<% } %>
					<form method="POST" action="/profacileweb/coach" class="counter_form_content d-flex flex-column align-items-center justify-content-center">
							...
							<p><a href="/profacileweb/coach/register1">Pas encore inscrit? S'inscrire</a></p>
						</form>
						</div>
					</div>
