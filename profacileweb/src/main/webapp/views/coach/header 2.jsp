...
<html lang="en">
<head>
<title>Profacile-Rendre l'education facile -Coach</title>
<meta charset="utf-8">
						...
						<div class="col">
							<div class="top_bar_content d-flex flex-row align-items-center justify-content-start">
								...
								<div class="top_bar_login ml-auto">
									<div class="login_button"><a href="../coach/logout">Logout</a></div>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col">
						<div class="header_content d-flex flex-row align-items-center justify-content-start">
							<div class="logo_container">
								<a href="../">
									<div class="logo_text">Pro<span>facile</span> <span style='font-size:1em;color:black;'>Coach</span></div>
								</a>
							</div>
							<nav class="main_nav_contaner ml-auto">
							<ul class="main_nav">
								<li><a href="../coach/offres?is">Offres</a></li>
								<li><a href="../coach/meseleves">Mes élèves</a></li>
								<li><a href="../coach/calendrier">Calendrier</a></li>
								<li><a href="../coach/compte">Compte</a></li>
							</ul>
