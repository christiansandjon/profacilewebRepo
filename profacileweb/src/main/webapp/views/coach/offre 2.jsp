...
<p><a href="../coach/offrepost">Les offres donc vous avez postulés </a></p>
<h2>Offres disponibles</h2>
<% if(error.equals("false")){ %>
<h4 style="color:red;margin-top:1em;">Vous avez déjà souscris à cette offre</h4>
<% } %>

<% if(error.equals("true")){ %>
<h4 style="color:green;margin-top:1em;">Vous avez postulé avec succes</h4>
<% } %>
		...
		<% if(size!=0){ %>
							...
							<c:forEach var="listes" items="${lesoffres}">
									<tr>
										...
										<td><a href="../coach/postuler?l=${listes.id}"> Postuler</a></td>
									</tr>
