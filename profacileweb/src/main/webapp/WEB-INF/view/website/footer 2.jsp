				...
				<div class="col">
					<div class="newsletter_container d-flex flex-lg-row flex-column align-items-center justify-content-start">
						...
						<!-- Newsletter Content -->
							...
							<div class="newsletter_title">Inscrivez vous sur notre Newsletter et recevez des promotions</div>
							<div class="newsletter_subtitle">Abonnez-vous aux dernieres actualites sur nos meilleures offres que nous proposons</div>
						</div>
								...
								<div class="footer_section footer_links">
									...
									<div class="footer_links_container">
										<ul>
											...
											<li><a href="courses.html">Nos cours</a></li>
