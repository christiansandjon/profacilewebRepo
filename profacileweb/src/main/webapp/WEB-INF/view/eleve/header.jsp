...
<html lang="en">
<head>
<title>Profacile-Rendre l'education facile - Etudiant</title>
<meta charset="utf-8">
						...
						<div class="col">
							<div class="top_bar_content d-flex flex-row align-items-center justify-content-start">
								...
								<div class="top_bar_login ml-auto">
									<div class="login_button"><a href="../../student/logout">Logout</a></div>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col">
						<div class="header_content d-flex flex-row align-items-center justify-content-start">
							<div class="logo_container">
								<a href="/profacileweb/">
									<div class="logo_text">Pro<span>facile</span> <span style='font-size:1em;color:black;'></span></div>
								</a>
							</div>
							<nav class="main_nav_contaner ml-auto">
							<ul class="main_nav">
								<li><a href="/profacileweb/student/calendrier">Calendrier</a></li>
								<li><a href="/profacileweb/student/mescours">Mes cours</a></li>
								<li><a href="/profacileweb/student/enseignant">Enseignants</a></li>
								<li><a href="/profacileweb/student/compte">Mon profil</a></li>
							</ul>
