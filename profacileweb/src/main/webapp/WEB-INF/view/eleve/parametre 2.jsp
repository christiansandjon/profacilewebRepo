...
<input type="text" class="comment_input" name="prenom" placeholder="Pr?nom" value="${eleve.prenom}" required="required">
<input type="text" class="comment_input" name="adresse" value="${eleve.adresse}" placeholder="Adresse">
<input type="text" class="comment_input" name="telephone" value="${eleve.telephone}" placeholder="T?l?phone">
...
<input type="text" class="comment_input" name="niveauScolaire" value="${eleve.niveauScolaire}" placeholder="NiveauScolaire" required="required">
...
if(resp==null){
	...
	if(resp == "1"){
		System.out.println("<h4 style='color:red;'>Les nouveaux mots de passe ne correspondent pas</h4>");
	}
	if(resp == "2"){
		System.out.println("<h4 style='color:red;'>Ancien Mot de passe errone</h4>");
	}
	if(resp == "0"){
		System.out.println("<h4 style='color:green;'>Mise a jour effectuee</h4>");
