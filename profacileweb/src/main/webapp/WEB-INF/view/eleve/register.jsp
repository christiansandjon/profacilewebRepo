			...
			<div class="container">
				<div class="row">
					...
					<form method="POST" action="/profacileweb/student/register" class="counter_form_content d-flex flex-column align-items-center justify-content-center">
							...
							<select class="comment_input" name="niveauScolaire" id="counter_select">
							...
							<p><a href="/profacileweb/student/">Deja inscrit? Se connecter</a></p>
						</form>
						</div>
					</div>
					...
					<div class="col-lg-6">
						<div class="contact_info">
							...
							<div class="contact_info_text">
								...
								<p><a href="../..professeur/">Devenez Professeur</a></p>
							</div>
						</div>
					</div>
				</div>
