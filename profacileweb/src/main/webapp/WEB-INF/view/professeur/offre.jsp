...
<p><a href="../professeur/offrepost">Les offres donc vous avez postules </a></p>
<h2>Offres disponibles</h2>
<% if(error.equals("false")){ %>
<h4 style="color:red;margin-top:1em;">Vous avez deja souscris a cette offre</h4>
<% } %>

<% if(error.equals("true")){ %>
<h4 style="color:green;margin-top:1em;">Vous avez postule avec succes</h4>
<% } %>
		...
		<% if(size!=0){ %>
							...
							<c:forEach var="listes" items="${lesoffres}">
									<tr>
										<td>Cours ${listes.cours.intitule} <br/>Niveau:${listes.niveau} <br/>publier le:${listes.datepub}<br/>Par ${listes.eleve.nom} ${listes.eleve.prenom}</td>
										<td><a href="../professeur/postuler?l=${listes.id}"> Postuler</a></td>
									</tr>
					...
					<div class="col-lg-6">
						<div class="contact_info">
							...
							<div class="contact_info_text">
								<p> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec vel gravida arcu. Vestibulum feugiat, sapien ultrices fermentum congue, quam velit venenatis sem
								</p>
