...
%>
					...
					<div class="col-lg-6">
						<div class="contact_form">
							<div class="contact_info_title">Mes eleves</div>
							<table class="tab">
								<c:forEach var="mescours" items="${mescours}">
									<tr>
										<td>
										elave:<span style="font-weight:bold;">${mescours.offre.eleve.nom} ${mescours.offre.eleve.prenom}</span></br>Email:<span style="font-weight:bold;">${mescours.offre.eleve.email}</span></br>Telephone:<span style="font-weight:bold;">${mescours.offre.eleve.telephone}</span></br>
