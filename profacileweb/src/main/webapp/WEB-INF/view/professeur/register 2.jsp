				...
				<div class="row">
					...
					<div class="col-lg-6">
						<div class="contact_form">
							<div class="contact_info_title">Creer un compte Profacile Professeur</div>
					...
					<% } %>
					<form method="POST" action="/profacileweb/professeur/register1" class="counter_form_content d-flex flex-column align-items-center justify-content-center">
							...
							<input type="password" class="comment_input" name="password" placeholder="Votre Mot de passe (Obligatoire):" required="required">
							
					
							<button type="submit" class="comment_button trans_200">Continuer ></button>
							<p><a href="/profacileweb/professeur/">Deja inscrit? Se connecter</a></p>
						</form>
						</div>
					</div>
					...
					<div class="col-lg-6">
						<div class="contact_info">
							...
							<div class="contact_info_text">
								...
								<p><a href="../student/">Devenez eleve</a></p>
							</div>
						</div>
					</div>
				</div>
